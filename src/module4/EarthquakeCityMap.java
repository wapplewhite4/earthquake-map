...
public class EarthquakeCityMap extends PApplet {
	...
	private void printQuakes() 
	{
		...
		//Total # of ocean quakes
		int oqFinal = 0;
		//Total # of country quakes
		int totalCQ = 0;
        ...
        for (Marker cm : countryMarkers) {
        	...
        	if (countryCounter != 0) {	
        	System.out.println((String)cm.getProperty("name") + ": " + countryCounter);
        	totalCQ += countryCounter;
        	} 	
        	oqFinal = numQuakes - totalCQ;
        }
        
        System.out.println("OCEAN QUAKES" + ": " + oqFinal);
