...
public class EarthquakeCityMap extends PApplet {
	...
	public void setup() {		
		...
		if (offline) {
		 ...
		 //earthquakesURL = "EQTop201900-2000.csv";
		}
		else {
	...
	//	earthquakesURL = "quiz2.atom";
	  ...
	  // List<PointFeature> earthquakes = ParseFeed.loadTop20QuakesFromCSV(this, earthquakesURL);
	...
	//	fill(255);
	//	rect(xbase+225, ybase, 300, 20);
	//	fill(0);
	//	text("Top 20 Earthquakes by Magnitude 1900-2000", xbase+235, ybase+7);
